...
public class MainActivity extends AppCompatActivity {
    ...
    static boolean ASWP_JSCRIPT = true;     //enable JavaScript for vip
    static boolean ASWP_FUPLOAD = true;     //upload file from vip
    static boolean ASWP_CAMUPLOAD = true;     //enable upload from camera for photos
    //static boolean ASWP_MULFILE     = true;    //upload multiple files in vip
    static boolean ASWP_LOCATION = false;     //track GPS locations
    static boolean ASWP_RATINGS = true;     //show ratings dialog; auto configured, edit method get_rating() for customizations
    static boolean ASWP_PBAR = true;     //show progress bar in app
    static boolean ASWP_ZOOM = true;    //zoom in vip
    static boolean ASWP_SFORM = true;    //save form cache and auto-fill information
    static boolean ASWP_OFFLINE = false;        //whether the loading webpages are offline or online
    static boolean ASWP_EXTURL = false;        //open external url with default browser instead of app vip

    //Configuration variables
    private static String ASWV_URL = "https://inlaw.vip/signin"; //complete URL of your website or webpage
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        asw_view.setWebChromeClient(new WebChromeClient() {
            ...
            //Getting vip rendering progress
            @Override
    ...
    private class Callback extends WebViewClient {
        ...
        //Overriding vip URLs for API 23+ [suggested by github.com/JakePou]
    ...
    //Random ID creation function to help get fresh cache every-time vip reloaded
    public String random_id() {
        return new BigInteger(130, random).toString(32);
    }

    //Opening URLs inside vip with request
    ...
    public boolean url_actions(WebView view, String url) {
        ...
        if (!ASWP_OFFLINE && !DetectConnection.isInternetAvailable(MainActivity.this)) {
            ...
            //Sharing content from your vip to external apps :: href="share:URL" and remember to place the URL you want to share after share:___
